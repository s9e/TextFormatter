...
class ConfiguratorTest extends Test
{
	...
	*/
	public function testAsConfigFinalize()
	{
		...
		$this->assertArrayMatches(
			array('plugins' => array('Dummy' => array('finalized' => true))),
			$config
		);
	}
	...
	*/
	public function testAddHTML5RulesRootNoOverwrite()
	{
		...
		$this->configurator->addHTML5Rules(array('parentHTML' => '<pre>'));
	...
	*/
	public function testSaveBundleForwardParameters()
	{
		...
		$mock->expects($this->once())
		     ->method('generate')
		     ->with('Foo', array('finalizeParser' => 'finalize'));

		$this->configurator->bundleGenerator = $mock;
		$this->configurator->saveBundle('Foo', $this->tempnam(), array('finalizeParser' => 'finalize'));
	}
	...
	*/
	...
	{
		$return = $this->configurator->finalize(array('returnParser' => false));
	...
	*/
	...
	{
		$return = $this->configurator->finalize(array('returnRenderer' => false));
	...
	*/
	...
	{
		$configurator = $this->getMock('s9e\\TextFormatter\\Configurator', array('addHTML5Rules'));
	...
	*/
	public function testFinalizeAddHTML5RulesOptions()
	{
		...
		$configurator->finalize(array('foo' => 'bar'));
	}
	...
	*/
	public function testFinalizeNoAddHTML5Rules()
	{
		...
		$configurator->finalize(array('addHTML5Rules' => false));
	}
	...
	*/
	public function testFinalizeParserCallback()
	{
		...
		$this->configurator->finalize(array('finalizeParser' => array($mock, 'foo')));
	}
	...
	*/
	public function testFinalizeRendererCallback()
	{
		...
		$this->configurator->finalize(array('finalizeRenderer' => array($mock, 'foo')));
	}
	...
	*/
	public function testFinalizeOptimizeConfig()
	{
		...
		$return1 = $this->configurator->finalize(array('optimizeConfig' => false));
		$return2 = $this->configurator->finalize(array('optimizeConfig' => true));

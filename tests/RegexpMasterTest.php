...
class RegexpMasterTest extends Test
{
	...
	/**
	* @testdox buildRegexpFromList(['foo']) produces 'foo'
	*/
	...
	*/
	public function test_buildRegexpFromList_247eefce()
	{
		$this->assertSame(
			'(?=[bf])(?:bar|foo)',
	...
	*/
	public function test_buildRegexpFromList_69483dd6()
	{
		$this->assertSame(
			'(?=[*\\\\])(?:\\*foo|\\\\bar)',
			$this->rm->buildRegexpFromList(array('*foo', '\\bar'))
	...
	*/
	public function test_buildRegexpFromList_17d99f17()
	{
		$this->assertSame(
			'(?:bar|foo)',
	...
	*/
	...
	/**
	* @testdox buildRegexpFromList(['aax', 'aay', 'aax', 'aay']) produces 'aa[xy]'
	*/
	...
	/**
	* @testdox buildRegexpFromList(['ax', 'ay', 'bx', 'by']) produces '[ab][xy]'
	*/
	...
	/**
	* @testdox buildRegexpFromList(['aaax', 'aaay', 'baax', 'baay']) produces '[ab]aa[xy]'
	*/
	...
	/**
	* @testdox buildRegexpFromList(['aaax', 'aaay', 'bbaax', 'bbaay']) produces '(?=[ab])(?:a|bb)aa[xy]'
	*/
	public function test_buildRegexpFromList_fc8a225f()
	{
		$this->assertSame(
			'(?=[ab])(?:a|bb)aa[xy]',
	...
	/**
	* @testdox buildRegexpFromList(['aaax', 'aaay', 'aax', 'aay']) produces 'aaa?[xy]'
	*/
	...
	/**
	* @testdox buildRegexpFromList(['afoo', 'abar', 'bbfoo', 'bbbar']) produces '(?=[ab])(?:a|bb)(?:bar|foo)'
	*/
	public function test_buildRegexpFromList_90bbb08c()
	{
		$this->assertSame(
			'(?=[ab])(?:a|bb)(?:bar|foo)',

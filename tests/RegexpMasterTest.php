...
class RegexpMasterTest extends Test
{
  ...
  'd' => '\\d',
	...
	*/
	...
	/**
	* @testdox buildRegexpFromList(['aa', 'bb', 'aaccxx', 'aaddxx', 'bbccxx', 'bbddxx', 'aa', 'bb', 'aaccyy', 'aaddyy', 'bbccyy', 'bbddyy']) returns '(?:aa|bb)(?:(?:cc|dd)(?:xx|yy))?'
	*/
	public function test_buildRegexpFromList_b443336c()
	{
		$this->assertSame(
			'(?:aa|bb)(?:(?:cc|dd)(?:xx|yy))?',
			$this->rm->buildRegexpFromList(array('aa', 'bb', 'aaccxx', 'aaddxx', 'bbccxx', 'bbddxx', 'aa', 'bb', 'aaccyy', 'aaddyy', 'bbccyy', 'bbddyy'))
		);
	}

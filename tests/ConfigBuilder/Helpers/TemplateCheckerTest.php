...
/**
* @covers s9e\TextFormatter\ConfigBuilder\Helpers\TemplateChecker
*/
class TemplateCheckerTest extends Test
{
	/**
	* @testdox checkUnsafe() throws an exception on invalid XML
	* @expectedException s9e\TextFormatter\ConfigBuilder\Exceptions\InvalidXslException
	...
	public function testCheckUnsafe($template, $exceptionMsg = null, array $tagOptions = array())
	{
		if (isset($exceptionMsg))
		{
			$this->setExpectedException(
				's9e\\TextFormatter\\ConfigBuilder\\Exceptions\\UnsafeTemplateException',
				$exceptionMsg
			);
		}

...
/**
* @covers s9e\TextFormatter\Generator\Helpers\TemplateChecker
*/
class TemplateCheckerTest extends Test
{
	...
	*/
	...
	{
		TemplateChecker::checkUnsafe('<x><?php ?></x>', new Tag);
	}
	...
	public function testCheckUnsafe($template, $exceptionMsg = null, array $tagOptions = array())
	{
		if (isset($exceptionMsg))
		{
			$this->setExpectedException(
				's9e\\TextFormatter\\Generator\\Exceptions\\UnsafeTemplateException',
				$exceptionMsg
			);
		}

...
namespace s9e\TextFormatter\Tests\Generator\Traits;
...
/**
* @covers s9e\TextFormatter\Generator\Traits\Configurable
*/
class ConfigurableTest extends Test
{
	...
	* @expectedExceptionMessage Cannot replace property 'fooObject' of class 's9e\TextFormatter\Tests\Generator\Traits\Foo' with instance of 's9e\TextFormatter\Tests\Generator\Traits\Bar'
	*/
	...
	*/
	public function testMagicSetNormalizedCollection()
	{
		...
		$this->assertInstanceOf(
			's9e\\TextFormatter\\Generator\\Collections\\NormalizedCollection',
			$dummy->collection
		);

...
/**
* @covers s9e\TextFormatter\Generator\Collections\TagCollection
*/
class TagCollectionTest extends Test
{
	/**
	* @testdox add() returns an instance of s9e\TextFormatter\Generator\Items\Tag
	*/
	public function testAddNormalizeValue()
	{
		...
		$this->assertInstanceOf(
			's9e\\TextFormatter\\Generator\\Items\\Tag',
			$collection->add('x')
		);
	}

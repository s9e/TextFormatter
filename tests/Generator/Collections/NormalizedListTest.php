...
use s9e\TextFormatter\Generator\Collections\NormalizedList;
...
/**
* @covers s9e\TextFormatter\Generator\Collections\NormalizedList
*/
class NormalizedListTest extends Test
{
	...
	*/
	...
	{
		$mock = $this->getMock(
			's9e\\TextFormatter\\Generator\\Collections\\NormalizedList',
			array('append')
		);

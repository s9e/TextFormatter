...
use s9e\TextFormatter\Generator\Collections\FilterChain;
use s9e\TextFormatter\Generator\Items\CallbackTemplate;
use s9e\TextFormatter\Generator\Items\Filter;
use s9e\TextFormatter\Generator\Items\FilterLink;

/**
* @covers s9e\TextFormatter\Generator\Collections\FilterChain
*/
class FilterChainTest extends Test
{
	...
	*/
	...
	{
		$mock = $this->getMock(
			's9e\\TextFormatter\\Generator\\Collections\\FilterChain',
			array('append'),
			array(array())
		);
	...
	/**
	* @testdox PHP string callbacks are normalized to an instance of s9e\TextFormatter\Generator\Items\Filter
	*/
	public function testStringCallback()
	{
		...
		$this->assertInstanceOf(
			's9e\\TextFormatter\\Generator\\Items\\Filter',
			$this->filterChain[0]
		);
	}

	/**
	* @testdox PHP array callbacks are normalized to an instance of s9e\TextFormatter\Generator\Items\Filter
	*/
	...
	/**
	* @testdox Instances of s9e\TextFormatter\Generator\Items\CallbackTemplate are normalized to an instance of s9e\TextFormatter\Generator\Items\Filter
	*/
	...
	/**
	* @testdox Instances of s9e\TextFormatter\Generator\Items\Filter are added as-is
	*/

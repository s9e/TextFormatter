...
/**
* @covers s9e\TextFormatter\Generator\Collections\AttributeCollection
*/
class AttributeCollectionTest extends Test
{
	/**
	* @testdox add() returns an instance of s9e\TextFormatter\Generator\Items\Attribute
	*/
	public function testAddNormalizeValue()
	{
		...
		$this->assertInstanceOf(
			's9e\\TextFormatter\\Generator\\Items\\Attribute',
			$collection->add('x')
		);
	}

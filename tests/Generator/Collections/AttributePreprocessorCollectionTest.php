...
use s9e\TextFormatter\Generator\Collections\AttributePreprocessorCollection;
use s9e\TextFormatter\Generator\Items\AttributePreprocessor;

/**
* @covers s9e\TextFormatter\Generator\Collections\AttributePreprocessorCollection
*/
class AttributePreprocessorCollectionTest extends Test
{
	/**
	* @testdox add() returns an instance of s9e\TextFormatter\Generator\Items\AttributePreprocessor
	*/
	public function testClassName()
	{
		...
		$this->assertInstanceOf(
			's9e\\TextFormatter\\Generator\\Items\\AttributePreprocessor',
			$collection->add('x', '#x#')
		);
	}

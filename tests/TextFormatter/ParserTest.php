...
class ParserTest extends Test
{
	...
	*/
	...
	{
		$this->assertAttributeInvalid('int', '9999999999999999999');
	}

	public function testIntFilterRejectsNumbersInHexNotation()
	{
		$this->assertAttributeInvalid('int', '0x123');
	}
	...
	{
		$this->assertAttributeInvalid('integer', '0123');
	}

	public function testIntegerFilterRejectsNumbersInScientificNotation()
	{
		$this->assertAttributeInvalid('integer', '12e3');
	}
	...
	{
		$this->assertAttributeInvalid('integer', '9999999999999999999');
	}

	public function testIntegerFilterRejectsNumbersInHexNotation()
	{
		$this->assertAttributeInvalid('integer', '0x123');
	}
	...
	{
		$this->assertAttributeInvalid('uint', '9999999999999999999');
	}

	public function testUintFilterRejectsNumbersInHexNotation()
	{
		$this->assertAttributeInvalid('uint', '0x123');
	}
	...
	{
		$this->assertAttributeValid('number', '0123');
	}

	public function testNumberFilterRejectsNumbersInScientificNotation()
	{
		$this->assertAttributeInvalid('number', '12e3');
	}
	...
	{
		$this->assertAttributeValid('number', '9999999999999999999');
	}

	public function testNumberFilterRejectsNumbersInHexNotation()
	{
		$this->assertAttributeInvalid('number', '0x123');
	}

	public function testFloatFilterAcceptsWholeNumbers()
	{
		$this->assertAttributeValid('float', '123');
	}
	...
	{
		$this->assertAttributeValid('float', '0123', '123');
	}

	public function testFloatFilterAcceptsNumbersInScientificNotation()
	{
		$this->assertAttributeValid('float', '12e3', '12000');
	}
	...
	{
		$this->assertAttributeValid('float', '9999999999999999999', '1.0E+19');
	}

	public function testFloatFilterRejectsNumbersInHexNotation()
	{
		$this->assertAttributeInvalid('float', '0x123');
	}

...
class JavaScriptTest extends Test
{
	...
	*/
	...
	{
		$this->configurator->plugins->load('Escaper', array('quickMatch' => 'foo'));
	...
	*/
	...
	{
		$this->configurator->plugins->load('Escaper', array('quickMatch' => "\xC0"));
	...
	*/
	...
	{
		$this->configurator->plugins->load('Escaper', array('quickMatch' => "\xC0xÿz"));
	...
	*/
	...
	{
		$this->configurator->registeredVars = array('foo' => 'bar');
	...
	*/
	...
	{
		$this->configurator->registeredVars = array('cacheDir' => '', 'foo' => 'bar');
	...
	*/
	...
	{
		$this->configurator->javascript->exportMethods = array('preview');
		$js = $this->configurator->javascript->getParser();
	...
	*/
	...
	public function getEncodeTests()
	{
		return array(
			...
			array(
				new Dictionary(array('foo' => 'bar', 'baz' => 'quux')),
				'{"foo":"bar","baz":"quux"}'
			),
			array(
				new Dictionary(array('' => 'bar', 'baz' => 'quux')),
				'{"":"bar","baz":"quux"}'
			),
			array(
				new RegExp('^foo$'),
			...
			array(
				new Dictionary(array('foo' => "bar\r\n")),
				'{"foo":"bar\\r\\n"}'
			),
			array(
				new Dictionary(array("foo\r\n" => 'bar')),
				'{"foo\\r\\n":"bar"}'
			),
			array(
				new Dictionary(array('foo' => "bar\xE2\x80\xA8")),
				'{"foo":"bar\\u2028"}'
			),
			array(
				new Dictionary(array('foo' => "bar\xE2\x80\xA9")),
				'{"foo":"bar\\u2029"}'
			),
		);
	}

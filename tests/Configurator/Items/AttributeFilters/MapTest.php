...
class MapTest extends Test
{
	...
	*/
	...
	{
		$filter = new Map(array('foo' => 'bar'), true, false);
	...
	*/
	...
	{
		$filter = new Map(array('foo' => 'bar'), true, true);
	...
	*/
	...
	{
		$filter = new Map(array('foo' => 'bar'), true, true);
		$filter->setMap(array('foo' => 'bar'), true, false);
	...
	*/
	...
	{
		$filter = new Map(array('foo' => 'bar', 'baz' => 'foo()'), true, true);
	...
	*/
	...
	{
		$filter = new Map(array('foo' => 'bar', 'baz' => 'foo:bar'), true, true);
	...
	*/
	...
	{
		$filter = new Map(array('foo' => 'bar', 'baz' => "foo\rbar"), true, true);
		$this->assertFalse($filter->isSafeInJS());

		$filter = new Map(array('foo' => 'bar', 'baz' => "foo\nbar"), true, true);
		$this->assertFalse($filter->isSafeInJS());
	}
	...
	*/
	...
	{
		$filter = new Map(array('foo' => 'bar', 'baz' => "\xE2\x80\xA8"), true, true);
	...
	*/
	...
	{
		$filter = new Map(array('foo' => 'bar', 'baz' => "\xE2\x80\xA9"), true, true);

...
/**
* @covers s9e\TextFormatter\Configurator\Validators\StylesheetParameterName
*/
class StylesheetParameterNameTest extends Test
{
	/**
	...
	*/
	...
	{
		StylesheetParameterName::normalize('*invalid*');
	}
	...
	*/
	...
	{
		$this->assertTrue(StylesheetParameterName::isValid("foo"));
		$this->assertSame("foo", StylesheetParameterName::normalize("foo"));
	}
	...
	*/
	...
	{
		$this->assertFalse(StylesheetParameterName::isValid("*"));
	}
	...
	*/
	...
	{
		$this->assertFalse(StylesheetParameterName::isValid("foo:bar"));
	}
	...
	*/
	...
	{
		$this->assertFalse(StylesheetParameterName::isValid("foo\n"));
	}

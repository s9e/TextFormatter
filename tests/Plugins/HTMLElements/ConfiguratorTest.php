...
class ConfiguratorTest extends Test
{
	...
	*/
	public function testAliasElement()
	{
		...
		$this->assertArrayMatches(
			array('aliases' => array('a' => array('' => 'URL'))),
			$pluginConfig
		);
	}
	...
	*/
	public function testAliasAttribute()
	{
		...
		$this->assertArrayMatches(
			array('aliases' => array('a' => array('href' => 'url'))),
			$pluginConfig
		);
	}
	...
	*/
	public function testAsConfigAliasElement()
	{
		...
		$this->assertEquals(
			new Dictionary(array('a' => new Dictionary(array('' => 'URL')))),
	...
	*/
	public function testAsConfigAliasAttribute()
	{
		...
		$this->assertEquals(
			new Dictionary(array('a' => new Dictionary(array('href' => 'url')))),
			$pluginConfig['aliases']
		);
	}
}
...
class ConfiguratorTest extends Test
{
	...
	*/
	...
	{
		$this->configurator->plugins->load('Emoji', array('tagName' => 'FOO'));
	...
	*/
	...
	{
		$this->configurator->plugins->load('Emoji', array('attrName' => 'bar'));
	...
	*/
	...
	{
		$plugin = $this->configurator->plugins->load('Emoji', array('tagName' => 'FOO'));
	...
	*/
	...
	{
		$plugin = $this->configurator->plugins->load('Emoji', array('attrName' => 'bar'));

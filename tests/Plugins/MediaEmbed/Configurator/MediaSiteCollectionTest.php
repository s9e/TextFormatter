...
class MediaSiteCollectionTest extends Test
{
	...
	*/
	...
	{
		$collection = new MediaSiteCollection;
		$collection['foo'] = array('host' => 'foo.tld');
	...
	*/
	...
	{
		$collection = new MediaSiteCollection;
		$collection['foo'] = array('scheme' => 'bar');
	...
	*/
	public function testAsConfigHosts()
	{
		$collection = new MediaSiteCollection;
		$collection['foo'] = array('host' => 'foo.tld');
		$collection['bar'] = array('host' => array('bar.tld', 'bar.example'));

		$config = $collection->asConfig();

		$this->assertEquals(
			array('foo.tld' => 'foo', 'bar.tld' => 'bar', 'bar.example' => 'bar'),
			$config->get()
		);
	}
}
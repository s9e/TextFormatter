	...
	public function getPredefinedBBCodesTests()
	{
		return [
			...
			[
				...
				'<pre><code>echo "Hello world";</code><script async="" crossorigin="anonymous" data-hljs-style="github" integrity="sha384-fQc6882DqpMzcLWJbK07+Xnd8dceuG+q15iFvx+m/bAzjiBJeLnbNfaiXYzJBEn/" onload="hljsLoader.highlightBlocks(this.parentNode)" src="https://cdn.jsdelivr.net/gh/s9e/hljs-loader@1.0.28/loader.min.js"></script></pre>',
			],
			[
			...
			[
				'[code]echo "Hello world";[/code]',
				'<pre><code>echo "Hello world";</code><script async="" crossorigin="anonymous" integrity="sha384-fQc6882DqpMzcLWJbK07+Xnd8dceuG+q15iFvx+m/bAzjiBJeLnbNfaiXYzJBEn/" onload="hljsLoader.highlightBlocks(this.parentNode)" src="https://cdn.jsdelivr.net/gh/s9e/hljs-loader@1.0.28/loader.min.js"></script></pre>',
				function ($configurator)
				{
					$configurator->BBCodes->addFromRepository('CODE', 'default', [
						'style' => 'default'

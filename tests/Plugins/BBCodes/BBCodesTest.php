	...
	public function getPredefinedBBCodesTests()
	{
		return [
			...
			[
				...
				'<pre><code>echo "Hello world";</code></pre><script async="" crossorigin="anonymous" data-hljs-style="github-gist" data-hljs-url="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.15.10/build/" src="https://cdn.jsdelivr.net/gh/s9e/hljs-loader@1.0.1/loader.min.js"></script>',
			],
			[
				'[code=html]<b>Hello world</b>[/code]',
				'<pre><code class="language-html">&lt;b&gt;Hello world&lt;/b&gt;</code></pre><script async="" crossorigin="anonymous" data-hljs-style="github-gist" data-hljs-url="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.15.10/build/" src="https://cdn.jsdelivr.net/gh/s9e/hljs-loader@1.0.1/loader.min.js"></script>',
			],
			[
				'[code]echo "Hello world";[/code]',
				'<pre><code>echo "Hello world";</code></pre><script async="" crossorigin="anonymous" data-hljs-style="none" data-hljs-url="/path/to/highlight.js/" src="https://cdn.jsdelivr.net/gh/s9e/hljs-loader@1.0.1/loader.min.js"></script>',

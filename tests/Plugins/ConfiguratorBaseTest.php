...
class ConfiguratorBaseTest extends Test
{
	...
	*/
	...
	{
		$dummy = new DummyPluginConfigurator($this->configurator, array('bar' => 'baz'));
	...
	*/
	...
	{
		$dummy = new TagCreatingPluginConfigurator($this->configurator, array('attrName' => 'XXX'));
	...
	*/
	...
	{
		$dummy = new TagCreatingPluginConfigurator($this->configurator, array('tagName' => 'xxx'));
	...
	*/
	...
	{
		new EmptyPluginConfigurator($this->configurator, array('attrName' => 'XXX'));
	}
	...
	*/
	...
	{
		new EmptyPluginConfigurator($this->configurator, array('tagName' => 'XXX'));
	}

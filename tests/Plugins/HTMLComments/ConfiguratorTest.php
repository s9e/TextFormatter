...
class ConfiguratorTest extends Test
{
	...
	*/
	...
	{
		$this->configurator->plugins->load('HTMLComments', array('tagName' => 'FOO'));
	...
	*/
	...
	{
		$this->configurator->plugins->load('HTMLComments', array('attrName' => 'bar'));
	...
	*/
	...
	{
		$plugin = $this->configurator->plugins->load('HTMLComments', array('attrName' => 'bar'));

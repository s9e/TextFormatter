...
<pre data-s9e-livepreview-hash="" data-s9e-livepreview-onupdate="if(typeof hljsLoader!=='undefined')hljsLoader.highlightBlocks(this)">
	...
	<script async="" crossorigin="anonymous">
		...
		<xsl:if test="'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.1.1/build/' != 'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.1.1/build/'">
			<xsl:attribute name="data-hljs-url">
				https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.1.1/build/
			</xsl:attribute>
		</xsl:if>
		...
		<xsl:attribute name="integrity">sha384-ba7Ur3T69w24Ebn8VUD9BZT96SBrG8C9Q3lpq0jjEhTNoTWsE9JfO6j2wwCBdbTZ</xsl:attribute>
		<xsl:attribute name="onload">hljsLoader.highlightBlocks(this.parentNode)</xsl:attribute>
		<xsl:attribute name="src">https://cdn.jsdelivr.net/gh/s9e/hljs-loader@1.0.11/loader.min.js</xsl:attribute>
	</script>
</pre>
```
<table>
	...
	<tr>
		<td><code>url</code></td>
		<td>https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.1.1/build/</td>

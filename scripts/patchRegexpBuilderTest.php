...
include __DIR__ . '/../tests/Generator/Helpers/RegexpBuilderTest.php';

$test = new Generator\Helpers\RegexpBuilderTest;
...
$filepath = __DIR__ . '/../tests/Generator/Helpers/RegexpBuilderTest.php';

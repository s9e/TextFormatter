...
include __DIR__ . '/../tests/ConfigBuilder/Helpers/RegexpBuilderTest.php';

$test = new ConfigBuilder\Helpers\RegexpBuilderTest;
...
$filepath = __DIR__ . '/../tests/ConfigBuilder/Helpers/RegexpBuilderTest.php';

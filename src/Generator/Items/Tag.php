...
*/
namespace s9e\TextFormatter\Generator\Items;

use InvalidArgumentException;
use s9e\TextFormatter\Generator\ConfigProvider;
use s9e\TextFormatter\Generator\Collections\AttributeCollection;
use s9e\TextFormatter\Generator\Collections\AttributePreprocessorCollection;
use s9e\TextFormatter\Generator\Collections\Ruleset;
use s9e\TextFormatter\Generator\Collections\Templateset;

...
class Templateset extends NormalizedCollection
{
	...
	*
	* @see s9e\Generator\Helpers\TemplateChecker
	* @see s9e\Generator\Helpers\TemplateOptimizer
	*
	...
	*
	* @throws s9e\TextFormatter\Generator\Exceptions\UnsafeTemplateException
	*
